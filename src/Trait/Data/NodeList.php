...
//        d($name);
        ...
        if(array_key_exists('where', $options)){
            ...
            if(
                ...
                $url = [];
                $dir_controller = $object->config('controller.dir.where');
                ...
                if(File::exist($ramdisk_url_nodelist[0])){
                    ...
                    if($response){
                        if(
                            ...
                            $parse->storage()->data('raxon.org.parse.view.url', $data_url);
...
//                        }
                        ...
                        throw new Exception('Controller method not found: ' . $route->controller . '::' . $route->function . ' and ' . $e->getMessage());
                    }
                }
            }
        }
